...
st.header("Controle de pedidos do relatório Unicooper")
...
criar_tarefa_Omie=st.button("Download Extrato Omie Unicooper.")

if criar_tarefa_Omie:
    resp=requests.get(url_base+f'/start-projeto?&projeto={projeto}&nome={nome}&argumentos={'args'}')
    resp.text
    resp=resp.json()
